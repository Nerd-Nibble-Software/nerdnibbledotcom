      ...
      <section class="bg-white py-10">
        <div class="container px-3">
          ...
          <p>
            ...
            business does not have an online presence or wants to improve their
            website, that is also something we offer.
          </p>
          <p>
            Ultimately, we make tools and services that help small businesses
            run better. Scheduling, inventory management, and online payments.
            We want to launch your business into the future with our practical
            software solutions.
          </p>
          ...
          <div class="card bg-light shadow-none">
            <div class="card-body">
              ...
              <ul class="mb-0">
                <li class="text-italic">What would make my customers happy?</li>
                ...
                <li class="text-italic">How can I improve my overall sales?</li>
              </ul>
            </div>
          </div>
          <hr class="my-5" />
          ...
          <p className="lead">
            Be a practical company that works with our clients to make them feel
            comfortable.
          </p>
          <p>
            We understand change is difficult. We aim to never push complicated
            software onto our clients. Before we suggest a solution, we try to
            understand your processes.
          </p>
          <p>
            We either suggest an existing solution or design a new one for you.
            Our software is supposed to make your business more money and help
            you run it better.
          </p>
        </div>
      </section>
